...
Natural Earth 110m Admin-0 vector data, simplified into `data/world.js`.
Public domain — no attribution required, offered here voluntarily.
<https://www.naturalearthdata.com/about/terms-of-use/>

### GeoNames — settlement gazetteer (`js/seed.js`)
The `cities1000` export, licensed
[Creative Commons Attribution 4.0](https://creativecommons.org/licenses/by/4.0/).
Sampled to give the demo activities real place names and coordinates, and distilled into
`js/seed.js`. The raw dump is available from <https://download.geonames.org/export/dump/>.
...
### MapLibre GL JS 5.24.0 — basemap renderer
...
### pdf-lib 1.17.1 — Evaluation Report assembly
Loaded from unpkg in `js/app.js` the first time an Evaluation Report is built; it merges
uploaded PDFs and photos into the report and embeds the remaining files as attachments.
Licensed under the [MIT License](https://github.com/Hopding/pdf-lib/blob/master/LICENSE.md).
<https://pdf-lib.js.org>

### qrcode-generator 1.4.4 — QR codes in the Evaluation Report
By Kazuhiko Arase. Loaded from unpkg alongside pdf-lib. Licensed under the
[MIT License](https://github.com/kazuhikoarase/qrcode-generator/blob/master/LICENSE).
"QR Code" is a registered trademark of DENSO WAVE INCORPORATED.
<https://github.com/kazuhikoarase/qrcode-generator>

### Google Translate — shipped Arabic, and background translation
The Arabic in `js/catalog.js` was produced with Google Translate and is redistributed here as
translated text. It is also what the globalization layer (`js/i18n.js`) asks for records written
after installation, where the platform runs its own backend to reach it. Subject to Google's
terms; no account is used and no personal data is sent.
<https://policies.google.com/terms>

### MyMemory — background translation service
The fallback for the same job on an installation with no backend of its own. Free and
account-free, subject to MyMemory's own terms and daily limits. Personal data is never sent.
<https://mymemory.translated.net/doc/usagelimits.php>

An administrator can point the platform at a self-hosted LibreTranslate instance instead, in
**Globalization → Settings**, in which case nothing reaches a third party at all.
...
account** in `js/seed.js` is **synthetic**. The people are invented and the figures illustrate the status engine
