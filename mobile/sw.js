...
var CACHE = 'grassroots-mobile-v38';
...
self.addEventListener('fetch', function (e) {
  ...
  // The database API is NEVER cached. In LOCAL mode these responses are live
  // SQLite reads; serving a stale one would show the user data that no longer
  // exists (and hide data that does). Straight to the network, always.
